...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "*{\n  padding: 0;\n  margin: 0;\n  box-sizing: border-box;\n  font-size: 1.1rem;\n}\nbody{\n  height: 100vh;\n  width: 100vw;\n  display: flex;\n  flex-direction: column;\n  overflow-x: hidden;\n}\n.header, .search-container{\n  padding: 10px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n.search-container{\n  gap: 5px;\n}\n.search-container input, .search-container button{\n  font-size: 1.2rem;\n  padding: 6px;\n}\n.search-container input{\n  width: 20%;\n}\n.show-container{\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  flex: 1;\n  gap: 16px;\n  padding: 10px;\n}\n.img-container{\n  background-size: cover;\n  width: 250px;\n  height:366px;\n}\n.info-container{\n  width: 60%;\n  height: auto;\n}\n", "",{"version":3,"sources":["webpack://./src/assets/styles/styles.css"],"names":[],"mappings":"AAAA;EACE,UAAU;EACV,SAAS;EACT,sBAAsB;EACtB,iBAAiB;AACnB;AACA;EACE,aAAa;EACb,YAAY;EACZ,aAAa;EACb,sBAAsB;EACtB,kBAAkB;AACpB;AACA;EACE,aAAa;EACb,aAAa;EACb,uBAAuB;EACvB,mBAAmB;AACrB;AACA;EACE,QAAQ;AACV;AACA;EACE,iBAAiB;EACjB,YAAY;AACd;AACA;EACE,UAAU;AACZ;AACA;EACE,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,OAAO;EACP,SAAS;EACT,aAAa;AACf;AACA;EACE,sBAAsB;EACtB,YAAY;EACZ,YAAY;AACd;AACA;EACE,UAAU;EACV,YAAY;AACd","sourcesContent":["*{\n  padding: 0;\n  margin: 0;\n  box-sizing: border-box;\n  font-size: 1.1rem;\n}\nbody{\n  height: 100vh;\n  width: 100vw;\n  display: flex;\n  flex-direction: column;\n  overflow-x: hidden;\n}\n.header, .search-container{\n  padding: 10px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n.search-container{\n  gap: 5px;\n}\n.search-container input, .search-container button{\n  font-size: 1.2rem;\n  padding: 6px;\n}\n.search-container input{\n  width: 20%;\n}\n.show-container{\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  flex: 1;\n  gap: 16px;\n  padding: 10px;\n}\n.img-container{\n  background-size: cover;\n  width: 250px;\n  height:366px;\n}\n.info-container{\n  width: 60%;\n  height: auto;\n}\n"],"sourceRoot":""}]);
// Exports
...
/* harmony export */   "showGenres": () => (/* binding */ showGenres),
/* harmony export */   "showName": () => (/* binding */ showName),
/* harmony export */   "showNetwork": () => (/* binding */ showNetwork),
/* harmony export */   "showRating": () => (/* binding */ showRating),
/* harmony export */   "showStatus": () => (/* binding */ showStatus),
/* harmony export */   "showSummary": () => (/* binding */ showSummary)
/* harmony export */ });
...
const showNetwork = document.createElement('div');
...
async function fetchTvShow(keyword){
  ...
  try{
    const response = await axios__WEBPACK_IMPORTED_MODULE_0___default().get(`https://api.tvmaze.com/singlesearch/shows?q=${noSpaceKeyword}`);
...
function populate(name, genres, status, rating, network, summary, img){
  _DOM_js__WEBPACK_IMPORTED_MODULE_0__.imgContainer.style.backgroundImage = `url(${img})`;
  _DOM_js__WEBPACK_IMPORTED_MODULE_0__.showName.textContent = `Name: ${name}`;
  genres.forEach((genre) => {
    _DOM_js__WEBPACK_IMPORTED_MODULE_0__.showGenres.textContent = `Genres: ${_DOM_js__WEBPACK_IMPORTED_MODULE_0__.showGenres.textContent.replace('Genres:', '') + ' ' + genre}`;
  })
  _DOM_js__WEBPACK_IMPORTED_MODULE_0__.showStatus.textContent = `Status: ${status}`;
  _DOM_js__WEBPACK_IMPORTED_MODULE_0__.showRating.textContent = `Rating: ${rating}`;
  _DOM_js__WEBPACK_IMPORTED_MODULE_0__.showNetwork.textContent = `Network: ${network}`;
  _DOM_js__WEBPACK_IMPORTED_MODULE_0__.showSummary.innerHTML = summary;

  _DOM_js__WEBPACK_IMPORTED_MODULE_0__.infoContainer.append(_DOM_js__WEBPACK_IMPORTED_MODULE_0__.showName, _DOM_js__WEBPACK_IMPORTED_MODULE_0__.showGenres, _DOM_js__WEBPACK_IMPORTED_MODULE_0__.showStatus, _DOM_js__WEBPACK_IMPORTED_MODULE_0__.showRating, _DOM_js__WEBPACK_IMPORTED_MODULE_0__.showNetwork, _DOM_js__WEBPACK_IMPORTED_MODULE_0__.showSummary);
}
...
/* harmony import */ var _modules_fetchData__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/fetchData */ "./src/modules/fetchData.js");
...
_modules_DOM__WEBPACK_IMPORTED_MODULE_1__.searchBtn.addEventListener('click', async () => {
  if(_modules_DOM__WEBPACK_IMPORTED_MODULE_1__.searchBar.validity.valueMissing){
    alert('you must type a name');
    return;
  }
  const searchValue = _modules_DOM__WEBPACK_IMPORTED_MODULE_1__.searchBar.value;

  const showData = await (0,_modules_fetchData__WEBPACK_IMPORTED_MODULE_2__["default"])(searchValue);
  ...
  (0,_modules_populate__WEBPACK_IMPORTED_MODULE_3__["default"])(showName, showGenres, showStatus, showRating, showNetwork, showSummary, showImg);
})
